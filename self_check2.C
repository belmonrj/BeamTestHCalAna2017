...
void self_check2(bool log_scale=false)
{
  ...
  char *old_files[] = {
    "production/outputdir/3183_SignalShape.root",
    "production/outputdir/3183_SignalShape.root",
    "production/outputdir/3183_SignalShape.root",
    "production/outputdir/3183_SignalShape.root",
  };
  ...
  char *files[] = {
    "production/outputdir/3178_SignalShape.root",
    "production/outputdir/3178_SignalShape.root",
    "production/outputdir/3178_SignalShape.root",
    "production/outputdir/3178_SignalShape.root",
  };
  ...
  char *file_tag[] = { "LED Self Trigger","LED Trigger"};
          ...
          for(int ifile=0; ifile<2; ifile++)
            {
              ...
              TProfile * h = (TProfile*) fin->Get(Form("hSingal_Prof_ieta%d_iphi%d", ieta, iphi)+det);
              ...
              (ifile==0)? h->Draw("h"):h->Draw("h,Same");
              if(ifile==1 && towerid==3) legend->Draw("Same");
