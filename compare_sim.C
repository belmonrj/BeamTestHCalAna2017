...
void compare_sim()
{
  ...
  char* files[] = {"proto3_sim/Full/out_pi+.root", "proto3_sim/Full/out_pi-.root"};
  ...
  can->cd();
  legend->Draw("Same");
  can->Print("figures/RB_hcalonly_sim_resolution_comparison_pionplusminus.png");
  can->Print("figures/RB_hcalonly_sim_resolution_comparison_pionplusminus.pdf");
  can3->cd();
  legend2->Draw("Same");
